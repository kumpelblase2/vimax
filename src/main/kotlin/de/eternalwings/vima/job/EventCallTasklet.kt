...
@Component
class EventCallTasklet(private val videoRepository: VideoRepository, private val pluginManager: PluginManager,
                       private val applicationEventPublisher: ApplicationEventPublisher) : Tasklet {
