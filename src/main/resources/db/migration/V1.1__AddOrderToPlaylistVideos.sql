...
SET position =
        (SELECT rowid FROM playlist_videos pv WHERE pv.playlist_id = playlist_videos.playlist_id AND pv.video_id = playlist_videos.video_id) -
...
INSERT INTO playlist_videos_bak SELECT playlist_id, video_id, position FROM playlist_videos;
